/*
304.3.3 JOINS AND CLAUSE BANKING DATABASE 
...
/*
2: Problem Statement:
For each branch, list the branch name and city, plus the last name and title of each employee 
...
/*
4: Problem statement:
Show the last name and title of each employee, along with the last name and title of that 
employee's boss.
...
SELECT e.LAST_NAME AS "Name", e.TITLE AS "Title", m.LAST_NAME AS "Boss Name",
...
/*
5: Problem Statement:
For each account, show the name of the account's product, 
